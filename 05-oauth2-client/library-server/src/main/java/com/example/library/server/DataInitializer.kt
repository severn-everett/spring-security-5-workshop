...
class DataInitializer(
  ...
  private fun createUsers() {
    ...
    userRepository.save(
        User(
            ...
            "Library",
            "Administrator",
            listOf(Role.USER, Role.CURATOR, Role.ADMIN)
        )
    )
  ...
  private fun createBooks() {
    ...
    userRepository.findOneByEmail("user@example.com").ifPresent { user ->
      ...
      bookRepository.save(
          Book(
              ...
              listOf("Josh Long", "Kenny Bastiani"),
              false,
              null
          )
      )
      ...
      bookRepository.save(
          Book(
              ...
              listOf("Gene Kim", "Jez Humble", "Patrick Debois"),
              false,
              null
          )
      )
